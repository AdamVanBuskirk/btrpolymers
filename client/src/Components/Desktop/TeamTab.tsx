...
import { BsThreeDots, BsGear, BsPencil, BsTrash3 } from "react-icons/bs";
...
function TeamTab() {
    ...
    const [sortField, setSortField] = useState<"name" | "memberCount" | "goal">("name");
    ...
    return [...teams].sort((a, b) => {
      ...
      switch (sortField) {
        case "name":
            ...
            break;
        case "goal": {
            aVal = (a.actionGoal) ? a.actionGoal.toString() : "";
            bVal = (b.actionGoal) ? b.actionGoal?.toString() : "";
            break;
        }
        case "memberCount": {
    ...
    <div style={{ padding: "0px 20px 10px 20px" }}>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse" }}>
        <thead style={{ background: "#051a26", color: "#fff" }}>
            ...
            >
                Members{renderSortArrow("memberCount")}
            </th>
            <th
                style={{
                textAlign: "right",
        ...
        {filteredTeams.length > 0 ? (
            ...
            {filteredTeams.map((t, i) => {
                ...
                >
                    ...
                    <td style={{ padding: "10px" }}>{(t.actionGoal) ? t.actionGoal : <span style={{ fontSize: "9pt", fontStyle: "italic", color: "gray" }}>Using Company Setting</span>}</td>
                    <td
                        style={{ padding: "10px", textAlign: "right", cursor: "pointer", color: "#007bff" }}
        ...
        >
            ...
            {(companyState.members || [])
                .filter((m) => m.status !== "invited" && m.userId) // ✅ only include members with valid userId
                .map((m) => (
                    <label
                    key={m.userId!}
                    style={{
                    ...
                    <div
                        style={{
                        width: "120px",          // column width (tweak as needed)
                        textAlign: "right",
                        fontSize: "12px",
                        color: "#6b7280",
                        whiteSpace: "nowrap",
                    ...
                    <input
                        type="checkbox"
                        checked={selectedMembers.includes(m.userId!)} // ✅ safe due to filter above
